...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql="SELECT * FROM problems WHERE type={$data['type']}";
...
if($result->num_rows>0)
{
    ...
    $htmlCode= $htmlCode . $row["id"];
    $htmlCode= $htmlCode . ")\"><h3 class=\"card__title\">";
    $htmlCode=$htmlCode . $row["Titlu"];
    $continuare=" </h3><p class=\"card__content\">";
    $htmlCode=$htmlCode . $continuare;
    $htmlCode=$htmlCode . $row["cerinta"];
